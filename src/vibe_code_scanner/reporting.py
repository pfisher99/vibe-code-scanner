...
from .models import ChunkScanResult, FileScanResult, NormalizedFinding, RunSummary
...
def write_findings_json(run_dir: Path, summary: RunSummary, file_results: list[FileScanResult]) -> Path:
...
def write_index_markdown(run_dir: Path, summary: RunSummary, file_results: list[FileScanResult]) -> Path:
